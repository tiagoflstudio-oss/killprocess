...
class WhitelistTab(ctk.CTkFrame):
    ...
    def _build_content(self):
        ...
        ctk.CTkButton(input_f, text="ADICIONAR", fg_color="#10B981", hover_color="#059669", font=self.fonts["small_bold"], height=40, corner_radius=8, command=self.app.add_to_whitelist).pack(side="right")
